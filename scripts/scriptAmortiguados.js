...
var ipL, ipG, ipM, ipA, ipAm, ipMasb, radMas; // Entradas de longitud, gravedad, masa y amplitud
...
function start() {
  ...
  ipAm.onblur = reaction; // Asignar evento de pérdida de foco para la entrada de amplitud
